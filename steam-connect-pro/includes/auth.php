...
<div class="scp-box">
    ...
    <?php if(isset($_GET['steam_already_registered'])) : ?>
<div id="scp-sticky-error">
    این آکانت استیم از قبل در سایت ثبت شده است<br>
    جهت راهنمایی لطفا به پشتیبانی پیام دهید.
</div>
...
if (!preg_match('/^\d{17}$/', $steam_id)) {
    ...
    exit;
     ...
     // بررسی کن آیا این استیم قبلا برای یوزر دیگری ثبت شده
...
// اگر ثبت نشده → یوزر بساز و لاگین کن
